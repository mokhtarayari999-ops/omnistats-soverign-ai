...
<style>
    ...
    /* بطاقة النتيجة المعمارية - مضادة للكسر */
...
if st.button("🔱 إطلاق التحليل السيادي"):
    with st.spinner('🎯 جاري معالجة 500,000 سيناريو...'):
        ...
        # ✅ الحقن المعماري (نظام القطعة الواحدة لمنع ظهور الكود الخام)
